"""
Django settings for property_approval_dashboard project.
...
SECRET_KEY = 'django-insecure-6q*o%bh(f_0g9v^u(vd60gi270!w5l(u38$ypb_ubld*g&mdtg'
...
ROOT_URLCONF = 'property_approval_dashboard.urls'
...
WSGI_APPLICATION = 'property_approval_dashboard.wsgi.application'
